...
class SpeakerDiarization(pl.LightningModule):
    ...
    def __init__(self, hparams, model, datasets, opt, scheduler, collate_func) -> None:
        ...
        # Add storage for validation and test outputs (PyTorch Lightning v2.0)
    ...
    def validation_step(self, batch, batch_index):
        ...
        # Store outputs for epoch end (PyTorch Lightning v2.0)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        # Clear for next epoch (PyTorch Lightning v2.0)
