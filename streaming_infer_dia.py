...
if __name__ == "__main__":
    ...
    parser.add_argument("--wav_path", type=str, default=r"C:\Users\Rishabh Singh\Downloads\FineTuning_LS-EEND\FS-EEND\FS-EEND\FS-EEND_test_samples_mix_0000176.wav", help="Path to input wav file")
    ...
    parser.add_argument("--test_from_file", default=r"C:\Users\Rishabh Singh\Downloads\FineTuning_LS-EEND\FS-EEND\FS-EEND\merged_inference.ckpt", help="Checkpoint file to test training")
